class Carousel {
    constructor(carouselElement) {
        ...
        this.prevBtn = carouselElement.querySelector('.carousel__botao--prev');
        this.nextBtn = carouselElement.querySelector('.carousel__botao--next');
        this.currentIndex = 0;
...
class MobileMenu {
    constructor() {
        ...
        this.menuItens = document.querySelector('.menu__itens');
        this.botaoContato = document.querySelector('.cabecalho__botao');
